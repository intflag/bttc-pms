...
public class StatusResult implements Serializable {
    ...
    public static StatusResult build(Integer status, Integer code, String msg, Object data) {
        return new StatusResult(status, code, msg, data);
    }

    public StatusResult(Integer status, Integer code, String msg, Object data) {
        this.status = status;
        this.code = code;
        this.msg = msg;
        this.data = data;
